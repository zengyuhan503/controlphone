<template>
  <div>
    ...
    <div class="option-List">
      ...
      <input type="file" ref="fileimg" id="fileload" @change="getFile" capture="camera" accept="image/*"
  ...
  export default {
    ...
    methods: {
      ...
      uploadimg() {
        ...
        if (this.num == 3) {
          var urls =
            "http://www.small-spark.com/face/end_class?account=" + account;
        } else {
          var urls =
            "http://www.small-spark.com/face/start_class?account=" +
            account +
            "&type=" +
            this.num;
        }
